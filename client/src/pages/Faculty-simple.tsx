    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 dark:text-gray-500">Manage faculty members and their information</p>
        </div>
        <Button>
      ...
      <Card>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8">
              <p className="text-gray-500 dark:text-gray-400 dark:text-gray-500">No faculty members found.</p>
